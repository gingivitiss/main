...
public class UniqueAppointmentListTest {
    ...
    public final UniqueAppointmentList uniqueAppointmentList = new UniqueAppointmentList(new Analytics(), 2);
    ...
    public void setAppointment_editedAppointmentHasDifferentIdentity_success() {
        ...
        UniqueAppointmentList expectedUniqueAppointmentList = new UniqueAppointmentList(new Analytics(), 4);
    ...
    public void remove_existingAppointment_removesAppointment() {
        ...
        UniqueAppointmentList expectedUniqueAppointmentList = new UniqueAppointmentList(new Analytics(), 2);
        assertEquals(expectedUniqueAppointmentList, uniqueAppointmentList);
    }
